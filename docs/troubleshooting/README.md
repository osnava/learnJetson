...
| 3 | Locking clocks + fan for sustained MAXN_SUPER inference (and the three claimants that steal the fan back) | [lock-clocks-fan-maxn-super.md](lock-clocks-fan-maxn-super.md) | ✅ Verified in the field |
